...
return {
    ...
    Function = function(CorePackage, WindLib, IntroLib, Windy, ClientPackage, PromptPackage, CoruTask, ESPF, CommonF, TheMimicPaints)
        ...
        Functions.PairingSections = IB_NO_VIRTUALIZE(function(tab, data, p)
        ...
        Functions.GiveLantern = IB_NO_VIRTUALIZE(function()
            for _,v in pairs(GetChildren(R.Inventory.SkinsInfo)) do
                v.Parent = Backpack;
            end;
        end);
        Functions.PlayEmote = IB_NO_VIRTUALIZE(function()
        ...
        Functions.B1C4AutoComplete = IB_NO_VIRTUALIZE(function()
        ...
        Functions.ESPMonsterBook1 = IB_NO_VIRTUALIZE(function(state)
            if state then
                if GameAI then
        ...
        Functions.ESPItemBook1 = IB_NO_VIRTUALIZE(function(state)
            if state then
        ...
        Functions.B2C1Func = IB_NO_VIRTUALIZE(function(self, where)
            self.B2C1_Cahce = self.B2C1_Cahce or {};
            ...
            elseif where == "Rat/Auto" then
                local RatDescendants = (self.B2C1_Cahce.RatF and GetDescendants(self.B2C1_Cahce.RatF)) or {};
                local WellChildren = (self.B2C1_Cahce.Well and GetChildren(self.B2C1_Cahce.Well)) or {};
                local BellChildren = (self.B2C1_Cahce.Bell and GetChildren(self.B2C1_Cahce.Bell)) or {};
                if #BellChildren == 0 then local AllDescendants = GetDescendants(W);
                    ...
                    self.B2C1_Cahce.RatF = ratPrompt.Parent.Parent.Parent;
                    ...
                    self.B2C1_Cahce.Well = wellPrompt.Parent;
                    ...
                    self.B2C1_Cahce.Bell = bellPrompt.Parent;
        ...
        Functions.GetPot = IB_NO_VIRTUALIZE(function(des)
        ...
        Functions.PlaceCoun = IB_NO_VIRTUALIZE(function(des)
            if not B2C2Con.AutoCook then return; end;
            local Prompt = CommonF.findPrompt(des, function(v)
        ...
        Functions.ToPot = IB_NO_VIRTUALIZE(function(des)
            if not B2C2Con.AutoCook then return; end;
            local Prompt = CommonF.findPrompt(des, function(v)
                return v.Parent.Parent.Name == "WoodenCounter" and IsA(v.Parent, "BasePart")
            end); if Prompt then
        ...
        Functions.ToStove = IB_NO_VIRTUALIZE(function()
            if not B2C2Con.AutoCook then return; end;
            local Prompt = CommonF.findPrompt(GetDescendants(W), function(v)
        ...
        Functions.GetBowl = IB_NO_VIRTUALIZE(function(des)
            if not B2C2Con.AutoCook then return; end;
            local Prompt = CommonF.findPrompt(des, function(v)
        ...
        Functions.TurnInFood = IB_NO_VIRTUALIZE(function(des)
            if not B2C2Con.AutoCook then return; end;
            local Prompt = CommonF.findPrompt(des, function(v)
        ...
        Functions.GrabFood = IB_NO_VIRTUALIZE(function(value)
            if not B2C2Con.AutoCook then return; end;
            local Prompt = CommonF.findPrompt(GetDescendants(W), function(v)
        ...
        Functions.GetBallGiver = IB_NO_VIRTUALIZE(function(self)
        ...
        Functions.GetNagisaLaser = IB_NO_VIRTUALIZE(function(self)
        ...
        Functions.GetCannonBalls = IB_NO_VIRTUALIZE(function(self)
        ...
        Functions.AntiNagisaLaser = IB_NO_VIRTUALIZE(function(self)
            local NagisaLaser = self:GetNagisaLaser();
            if NagisaLaser and NagisaLaser.Transparency ~= 1 then
                return CommonF.Tp(HumRSelf, CFr(1982.58, 100, -4780.12));
            end
        end);
        Functions.B2C2Func = IB_NO_VIRTUALIZE(function(self, where)
        ...
        Functions.B2C2ESP = IB_NO_VIRTUALIZE(function(self, where, state)
            if not state then
        ...
        Functions.B2C3Func = IB_NO_VIRTUALIZE(function(self, where)
            if where == "Gozu" then
        ...
        Functions.B2C3ESP = IB_NO_VIRTUALIZE(function(self, where, state)
            if not state then
                return ESPF.Destroy(where);
        ...
        Functions.B2C4BP1 = IB_NO_VIRTUALIZE(function()
        ...
        Functions.B2C4BP2 = IB_NO_VIRTUALIZE(function()
            -- Services
            local RunService = game:GetService("RunService")
            local ReplicatedStorage = game:GetService("ReplicatedStorage")
        ...
        Functions.GetLVecFromCLook = IB_NO_VIRTUALIZE(function(basePart, spr)
        ...
        Functions.MagicArrowHit = IB_NO_VIRTUALIZE(function(self, SpiritBow, BasePart, time)
        ...
        Functions.B2C4Func = IB_NO_VIRTUALIZE(function(self, where)
            if where == "Cave" then
        ...
        Functions.B2C4ESP = IB_NO_VIRTUALIZE(function(self, where, state)
            if not state then
                return ESPF.Destroy(where);
            else
        ...
        Functions.JigokuFunc = IB_NO_VIRTUALIZE(function(where)
            if where == "Talk" then
        ...
        Functions.NMCSFunc = IB_NO_VIRTUALIZE(function(where)
        ...
        Functions.NMCSESP = IB_NO_VIRTUALIZE(function(where, state)
            if not state then
                return ESPF.Destroy(where);
        ...
        CoruTask.New("Sama", IB_NO_VIRTUALIZE(function()
        ...
        CoruTask.New("Saigomo", IB_NO_VIRTUALIZE(function()
            if PlaceId ~= 7251867574 and PlaceId ~= 7265397848 then
                return;
        ...
        CoruTask.New("Cook", IB_NO_VIRTUALIZE(function()
        ...
        CoruTask.New("Mother", IB_NO_VIRTUALIZE(function()
            if PlaceId ~= 13489800654 then
        ...
        CoruTask.New("Cannon+Lazer", IB_NO_VIRTUALIZE(function()
            if PlaceId ~= 13489800654 then
        ...
        CoruTask.New("Nagisa Serpent", IB_NO_VIRTUALIZE(function()
            if PlaceId ~= 13489800654 then
        ...
        CoruTask.New("Yurei", IB_NO_VIRTUALIZE(function()
        ...
        CoruTask.New("EnzukaiRyu", IB_NO_VIRTUALIZE(function()
        ...
        CoruTask.New("EnzukaiMobs", IB_NO_VIRTUALIZE(function()
            if PlaceId ~= 96354063422506 then
        ...
        CoruTask.New("EnzukaiJin", IB_NO_VIRTUALIZE(function()
            if PlaceId ~= 96354063422506 then
        ...
        CoruTask.New("Ringmaster", IB_NO_VIRTUALIZE(function()
        ...
        CoruTask.New("Fly", IB_NO_VIRTUALIZE(function()
        ...
        local LSecureUI = function()
            ...
            local Tabs = {
                ...
                ChristmasTrial = ((not LoaderSettings.TheMimicLoader.Load_WithPlaceID_Check) or PlaceId == 7068952294 or PlaceId == 8311302084) and Window:Tab({ Title = "Christmas Trial", Icon = "snowflake" }),
